...
import json
import re
url = "https://vision.googleapis.com/v1/images:annotate?key=AIzaSyCE4s3JKnqvZRa3EKRgKohfy781sEz4F1s"
#
from db import addPlate
...
def detect_license_plate(encodedImage):
    ...
    print(result)
    addPlate(result['responses'][0]['textAnnotations'][0]['description'])
    try:
